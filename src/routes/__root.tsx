...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "O2 Ads is a results-driven digital marketing agency specializing in organic growth, authority SEO, personal branding, and bespoke content strategies." },
      { property: "og:image", content: "https://olbvthwsacrxhtmismza.supabase.co/storage/v1/object/public/assets/og-image.jpg" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://olbvthwsacrxhtmismza.supabase.co/storage/v1/object/public/assets/og-image.jpg" },
      { name: "twitter:site", content: "@o2_ads" },
      { name: "theme-color", content: "#0A0A0A" },
      { name: "twitter:title", content: "O2 Ads — We Don't Run Ads. We Build Brands." },
      { name: "twitter:description", content: "O2 Ads is a results-driven digital marketing agency specializing in organic growth, authority SEO, personal branding, and bespoke content strategies." },
    ],
    links: [
